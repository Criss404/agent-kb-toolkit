---
name: expand-note
description: 把知识库中一篇既有笔记深化为教材级学习内容(原理系统展开、多示例+反例、常见误区 FAQ、练习自测题),或对一个新主题做深度研究后写成教材级笔记。触发场景:用户说"深化/拓展某篇笔记/RAG-XX"、"拓展某主题"、"写成教材/深度笔记/expand note"等。需要联网多来源交叉研究,一次只处理一个主题。
